...
import { IonicPage, NavController, NavParams,AlertController,ModalController, Loading, LoadingController, Platform } from 'ionic-angular';
...
export class OtpPage {
    ...
    constructor(public navCtrl: NavController, public platform:Platform, public navParams: NavParams,public service:DbserviceProvider,public alertCtrl:AlertController,public modalCtrl: ModalController, private storage:Storage,public loadingCtrl:LoadingController,public translate:TranslateService) {
    ...
    submit()
    {
        ...
        .subscribe( (r) =>
        {
            ...
            if(r['status'] == 'NOT FOUND'){
                ...
                this.navCtrl.push(RegistrationPage,{'mobile_no':this.mobile_no,"lang":this.lang,"mode":"otp_page"})
                return;
            }
            ...
            else if(r['status'] == 'SUCCESS')
            {
                ...
                else if(r['user'].user_type ==3 && r['user'].is_active !='Active'){
                    this.translate.get("Your account has been deactivated")
                    .subscribe(resp=>{
                        // this.showExit(resp);
