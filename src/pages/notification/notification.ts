...
export class NotificationPage {
    ...
    lang:any='';
    karigar_id:any="";
    constructor(public navCtrl: NavController, public loadingCtrl:LoadingController, public navParams: NavParams,private app:App,public service:DbserviceProvider,public storage:Storage,public translate:TranslateService) {
        this.get_user_lang();
        this.presentLoading() 
