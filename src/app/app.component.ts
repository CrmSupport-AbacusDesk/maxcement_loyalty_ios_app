...
import { PurchaseListPage } from '../pages/purchase/purchase-list/purchase-list';
import { SiteListPage } from '../pages/site/site-list/site-list';
import { PcListPage } from '../pages/pc-list/pc-list';
...
export class MyApp {
    ...
    constructor( public platform: Platform, statusBar: StatusBar, splashScreen: SplashScreen,public market: Market,  public modalCtrl: ModalController,public storage:Storage,public events:Events,public constant:ConstantProvider, private app: App,public toastCtrl:ToastController,public service:DbserviceProvider,public alertCtrl:AlertController,public app_version:AppVersion,public translate:TranslateService,public push:Push,) 
    {
        ...
        platform.ready().then(() => {
            ...
            splashScreen.hide();    
            statusBar.backgroundColorByHexString('#ffdd19');   
            this.get_user_lang();
        });
    ...
    initPushNotification()
    {
        ...
        pushObject.on('notification').subscribe((notification: any) => {
            ...
            else if(notification.additionalData.type == 'pc'){
                this.nav.push(PcListPage);
            }
            else if(notification.additionalData.type == 'site'){
                this.nav.push(SiteListPage,{'user_type':this.service.karigar_info.user_type});
            }
            else if(notification.additionalData.type == 'purchase'){
                this.nav.push(PurchaseListPage, {'user_type':this.service.karigar_info.user_type});
            }
